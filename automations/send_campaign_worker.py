...
from dashboard.views import update_touchpoint_progress, _ses_send_mail, _append_unsubscribe_footer
    ...
    def _send_one(contact):
        try:
            ...
            final_body = _append_unsubscribe_footer(
                final_body, contact, is_html=(content_type == 'HTML'),
            )
