...
CSRF_TRUSTED_ORIGINS = ['https://workspace.moc-pty.com', 'http://workspace.moc-pty.com']
...
# Allow large file uploads (20 MB) — prevents Django 413 on template saves with attachments
...
# Set to None to send to real recipients
